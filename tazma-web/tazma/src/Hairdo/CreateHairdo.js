...
export default function CreateHairdo({ handleCloseDialog }) {
  ...
  const handleGenderButtonClick = (role) => {
    setGender(role.toUpperCase());
  };

  const images = [
    {
      url: process.env.PUBLIC_URL +'/male.png',
      title: 'Male',
      width: '33%',
    },
    {
      url: process.env.PUBLIC_URL +'/female.png',
      title: 'Female',
      width: '33%',
    },
    {
      url: process.env.PUBLIC_URL +'/unisex.png',
      title: 'Unisex',
      width: '33%',
    },
  ];
